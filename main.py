...
# from settings             import (PATH_DB_SERVER, PATH_RELEVAMIENTO, PATH_TABLA_CUITS,
#                                    OUTPUTS_DIR,
#                                    OUT_DIM_CLIENTES, OUT_DIM_HERRAMIENTAS,
#                                    OUT_DIM_RELEVAMIENTO, OUT_FACT_EJECUCIONES, OUT_DIAGNOSTICO)
...
#     # dim_herramientas: catálogo de herramientas únicas del relevamiento
#     dim_herramientas = (
...
#     # Agregar a dim_herramientas los procesos externos (fuera del Relevamiento)
#     herr_extra = (
...
#     # ── PASO 4: Exportar CSVs ─────────────────────────────────────────────────
#     banner("PASO 4 | Exportando tablas para Power BI...")
...
#     # ── PASO 5: Diagnóstico ───────────────────────────────────────────────────
#     banner("PASO 5 | Generando diagnóstico de calidad...")
...
def main() -> None:
    ...
    # ── PASO 4: fact_esperado (Real vs Esperado) ──────────────────────────────
